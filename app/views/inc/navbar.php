<div class="off-canvas position-right main-menu--off-canvas" id="off-canvas" data-off-canvas>
  <div class="off-canvas--logo">
    <a href="#">
      <img src="<?php echo URLROOT; ?>/wp-content/uploads/2018/05/logo-pediact-blanc.png" alt="" 
  ...
  <div class="off-canvas--navigation">
    <ul  class="vertical menu">
      ...
      <li class="menu-item menu-item-type-post_type menu-item-object-page">
        <a href="<?php echo URLROOT; ?>/pages/notrenaboratoire">Notre Laboratoire</a>
      </li>
      <li id="nousrejoindre" class="menu-item menu-item-type-post_type menu-item-object-page">
      ...
      <!-- <li id="menu-item-41668" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-41668">
        ...
        <ul class="vertical menu">
          <li id="menu-item-41669" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-41669">
            <a href="<?php echo URLROOT; ?>/pages/dermatologie">Dermatologie</a>
          </li>
          <li id="menu-item-41670" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-41670">
            <a href="<?php echo URLROOT; ?>/pages/fermentslactiques">Ferments Lactiques</a>
          </li>
          <li id="menu-item-41671" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-41671">
            <a href="<?php echo URLROOT; ?>/pages/nutritioninfantile">Nutrition Infantile</a>
          </li>
          <li id="menu-item-41672" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-41672">
            <a href="<?php echo URLROOT; ?>/pages/orl">ORL</a>
          </li>
          <li id="menu-item-41673" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-41673">
            <a href="<?php echo URLROOT; ?>/pages/pneumologie">Pneumologie</a>
          </li>
        </ul>
      </li> -->
