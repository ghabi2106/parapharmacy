...
<div id="content">
    ...
    <div id="inner-content" class="row">
        ...
        <main id="main" class="large-12 medium-12 columns" role="main">
            ...
            <div id="post-109" class="post-109 page type-page status-publish hentry" role="article">
                <!-- <header class="article-header">
    <h1 class="page-title">Nous Contacter</h1>
</header> -->
                <section class="entry-content" itemprop="mainContentOfPage">
                    <section id="section--hero" data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_section vc_custom_1532958595576 vc_section-has-fill vc_section-o-content-top vc_section-flex">
                    ...
                    <section id="section--contact-infos" data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_section">
                        ...
                        <div id="to-scroll" class="vc_row wpb_row vc_row-fluid contact-infos--row generic-wrapper vc_row-o-equal-height vc_row-flex">
                            <div class="contact-infos--column theme-yellow wpb_column vc_column_container vc_col-sm-8">
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                            ...
                            <div class="contact-infos--column right wpb_column vc_column_container vc_col-sm-4">
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
